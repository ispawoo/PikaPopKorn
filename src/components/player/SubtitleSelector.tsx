  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="flex flex-col max-h-[70vh]">
        <h3 className="text-lg font-bold text-white mb-4 shrink-0">Subtitles</h3>
        
        {availableSubtitles.length === 0 ? (
          <div className="flex flex-col gap-3 text-center py-4">
            <p className="text-zinc-400">Subtitles are managed by your device or none are available for this video.</p>
            <button
